...
def getManagers(url, filename,driver):
    def isExist(xpath):
        try:
...
def main():
    driver = set_Chrome()
    global info
    gp_url_0 = r'http://fund.eastmoney.com/data/fundranking.html#thh;c0;r;s1nzf;pn50;ddesc;qsd20200215;qed20210215;qdii;zq;gg;gzbd;gzfs;bbzt;sfbb' # 混合
    ...
    # filename = '天天基金指数型基金数据.txt'
        getManagers(gp_url, filename,driver)
        print("End")
    info.close()
    driver.close()
